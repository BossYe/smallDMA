...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/yxy/smallDMA/test_run_dir/ControllerSpec_should_perform_2D_MM2MM_transfer_with_stride_1_mem_to_2_slaves/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/yxy/smallDMA/test_run_dir/ControllerSpec_should_perform_2D_MM2MM_transfer_with_stride_1_mem_to_2_slaves/DMATopAXI_AXIL_AXI.vcd)";
